...
var KTDemoPanel = function() {
    ...
    var remind = function() {
        if (!(encodeURI(window.location.hostname) == 'betunion24.ru' || encodeURI(window.location.hostname) == 'www.betunion24.ru')) {
            return;
        }
...
var KTQuickSearch = function() {
    ...
    var requestTimeout = 2000; // ajax request fire timeout in milliseconds 
