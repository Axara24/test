...
var KTLayout = function() {
		...
		return new KTPortlet("kt_page_portlet", {
			sticky: {
				...
				position: {
					top: function() {
						var e = 0;
						return KTUtil.isInResponsiveRange("desktop") ? KTUtil.hasClass(t, "kt-header--fixed") && (e += parseInt(KTUtil.css(KTUtil.get("kt_header"), "height"))) : KTUtil.hasClass(t, "kt-header-mobile--fixed") && (e += parseInt(KTUtil.css(KTUtil.get("kt_header_mobile"), "height"))), e
					},
					left: function(t) {
						var e = t.getSelf();
	...
	return {
		init: function() {
			t = KTUtil.get("body"), this.initHeader(), this.initAside(), this.initPageStickyPortlet(), $("#kt_aside_menu, #kt_header_menu").on("click", '.kt-menu__link[href="#"]:not(.kt-menu__toggle)', function(t) {
				swal("", "You have clicked on a non-functional dummy link!"), t.preventDefault()
			})
		},
		initHeader: function() {
			var t, o;
			t = KTUtil.get("kt_header"), (o = {
				classic: {
					desktop: !0,
					mobile: !1
				},
				offset: {},
				minimize: {}
			}).minimize.mobile = !1, "on" == KTUtil.attr(t, "data-ktheader-minimize") ? (o.minimize.desktop = {}, o.minimize.desktop.on = "kt-header--minimize", o.offset.desktop = parseInt(KTUtil.css(t, "height")) - 10) : o.minimize.desktop = !1, e = new KTHeader("kt_header", o), n && (e.on("minimizeOn", function() {
				n.scrollReInit()
		...
		initAside: function() {
			var e, a, i, l, r, s, d;
			i = KTUtil.get("kt_aside"), KTUtil.get("kt_aside_brand"), l = KTUtil.hasClass(i, "kt-aside--offcanvas-default") ? "kt-aside--offcanvas-default" : "kt-aside", o = new KTOffcanvas("kt_aside", {
				baseClass: l,
				overlay: !0,
			...
			}), KTUtil.hasClass(t, "kt-aside--fixed") && (KTUtil.addEvent(i, "mouseenter", function(o) {
				o.preventDefault(), !1 !== KTUtil.isInResponsiveRange("desktop") && (a && (clearTimeout(a), a = null), e = setTimeout(function() {
			...
			}), KTUtil.addEvent(i, "mouseleave", function(o) {
				o.preventDefault(), !1 !== KTUtil.isInResponsiveRange("desktop") && (e && (clearTimeout(e), e = null), a = setTimeout(function() {
		...
		initPageStickyPortlet: function() {
			KTUtil.get("kt_page_portlet") && ((i = l()).initSticky(), KTUtil.addResizeHandler(function() {
				i.updateSticky()
			}), l())
		},
